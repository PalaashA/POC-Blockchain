...
## Setting Up the Developer Environment (`Ubuntu`) :
Follow these instructions on [this gist](https://gist.github.com/netizener/c39d9b5421d11afa7874fdf6d3f7ccf3) to setup your developer environment on Ubuntu (and other Ubuntu-based distributions like Linux Mint, Kubuntu, Lubuntu, Xubuntu, KDE Neon, elemenentaryOS etc..)
